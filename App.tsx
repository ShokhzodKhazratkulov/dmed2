...
import { DMEDLogo, Emblem, DMED_LOGO_URL } from './constants';
      ...
      <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-3xl p-8 shadow-2xl text-center">
          <div className="flex justify-center gap-4 mb-6">
            <div className="w-20 h-20 bg-blue-50 rounded-3xl flex items-center justify-center overflow-hidden p-4">
              <Emblem className="w-full h-full object-contain" />
            </div>
            <div className="w-20 h-20 bg-blue-50 rounded-3xl flex items-center justify-center overflow-hidden p-4">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-3">
              <Emblem className="w-10 h-10 object-contain" />
              <DMEDLogo />
            </div>
          ...
          <div className="animate-in fade-in slide-in-from-bottom-8 duration-700">
              ...
              <div className="relative z-10 max-w-2xl">
                <div className="inline-flex items-center gap-3 px-4 py-2 bg-white/10 backdrop-blur-md rounded-full text-[10px] font-black uppercase tracking-[2px] mb-8 border border-white/10">
                  <div className="flex items-center gap-2">
                    <Emblem className="w-5 h-5 object-contain" />
                ...
                <div className="flex flex-wrap gap-4 items-center">
                  <button 
                    ...
                    className="bg-white text-blue-700 px-10 py-5 rounded-2xl font-black uppercase tracking-wider text-sm hover:bg-cyan-50 transition-all shadow-xl hover:scale-105 active:scale-95 flex items-center gap-2"
                  >
                  ...
                  <button 
                    ...
                    className="bg-cyan-500/80 backdrop-blur-md border border-white/20 text-white px-10 py-5 rounded-2xl font-black uppercase tracking-wider text-sm hover:bg-cyan-400 transition-all flex items-center gap-3"
                  >
            ...
            <div className="bg-white border border-slate-100 rounded-[2.5rem] p-8 shadow-xl flex flex-col md:flex-row items-center justify-between gap-6 mb-12">
              ...
              <div className="flex gap-2">
                ...
                <span className="px-4 py-2 bg-slate-50 text-slate-400 rounded-xl text-xs font-black uppercase tracking-wider">Tasdiqlangan</span>
              </div>
            </div>
            ...
            <div className="bg-white p-12 rounded-[3rem] shadow-2xl border border-slate-100 text-center">
              <div className="flex justify-center gap-4 mb-8">
                <div className="w-20 h-20 bg-blue-50 rounded-3xl flex items-center justify-center">
                  <Emblem className="w-12 h-12 object-contain" />
                </div>
                <div className="w-20 h-20 bg-blue-50 rounded-3xl flex items-center justify-center">
        ...
        {activeTab === AppTab.HISTORY && (
          <div className="animate-in fade-in slide-in-from-bottom-8 duration-700">
            <div className="flex justify-between items-end mb-12">
              ...
              <button 
                onClick={() => setIsCreating(true)}
                className="bg-slate-900 text-white px-8 py-3 rounded-2xl font-black uppercase tracking-wider text-xs hover:bg-blue-600 transition-all flex items-center gap-2"
              >
